module.exports = (app)=>{
    ...
        //abrir o formulario de exibição do documento selecionado
    ...
            var altrar = await mygrid.findOneAndRemove({_id:id})
    
            //voltar para a pagina do mygrid
    ...
        app.post("/alterar_mygrid",async(req,res)=>{
        ...
                var altrar = await mygrid.findOneAndUpdate({_id:id},
